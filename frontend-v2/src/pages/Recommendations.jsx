  ...
  if (loading || locationLoading) {
    return (
      <div className="min-h-screen bg-[#FFF7E3] flex justify-center items-center">
        <div className="text-xl text-gray-600">Cargando recomendaciones...</div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#FFF7E3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">Actividades Sugeridas</h2>
                  ...
                  {activity.match_score && (
                    <div className="mt-4">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-sm font-medium text-[#3A6ECF]">
                          {Math.round(activity.match_score)}%
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div 
                          className="bg-[#3A6ECF] h-2 rounded-full" 
        ...
        {nearbyPlaces.length > 0 && (
          <div>
            <h2 className="text-2xl font-semibold mb-6">Lugares Cercanos</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="space-y-2">
                      <div className="inline-block bg-[#3A6ECF]/10 text-[#3A6ECF] text-xs font-medium px-2.5 py-0.5 rounded">
                        {place.category}
                      </div>
                      <div className="text-sm text-gray-500">
                        {place.address}
                      </div>
                      <div className="text-sm text-[#3A6ECF]">
      ...
      <div className="text-center mt-12 pb-8">
        <Link
          to="/"
          className="inline-flex items-center px-8 py-4 bg-[#FF4D1C] text-white rounded-lg hover:bg-[#E63900] transition-colors duration-200 text-lg font-medium"
        >
